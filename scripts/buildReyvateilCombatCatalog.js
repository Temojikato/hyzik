...
const roleTemplates = {
  vanguard: [
    ...
    ['Surge', 'quick', 'round', 1, 'Until your next turn, gain 2 Guard and advantage on Force saving throws.'],
    ...
    ['Overrun', 'quick', 'round', 1, 'Move up to half your movement through hostile spaces; the first enemy crossed takes Force damage.'],
  ...
  bulwark: [
    ...
    ['Anchor', 'quick', 'round', 1, 'Until your next turn, you cannot be moved and attacks against you have disadvantage.'],
    ...
    ['Advance', 'quick', 'round', 1, 'Move 2 spaces with one adjacent willing ally; neither of you provokes reactions.'],
  ...
  striker: [
    ...
    ['Feint', 'quick', 'round', 1, 'One enemy makes a Focus saving throw against your Save Difficulty; on failure it becomes Exposed until the next attack hits it.'],
    ...
    ['Vanish', 'quick', 'round', 1, 'Become Hidden until you attack, sing, or end a turn in clear sight.'],
  ...
  skirmisher: [
    ...
    ['Accelerate', 'quick', 'round', 1, 'Gain 3 spaces of movement and advantage on Finesse saving throws until your next turn.'],
    ...
    ['Updraft', 'quick', 'round', 1, 'Leap to any visible space within 4 spaces, ignoring creatures, reactions, and difficult terrain.'],
  ...
  controller: [
    ...
    ['Distort', 'quick', 'round', 1, 'One creature within 5 spaces makes a Guard saving throw against your Save Difficulty. On failure, move it up to 2 spaces.'],
  ...
  support: [
    ...
    ['Uplift', 'quick', 'round', 1, 'An ally within 5 spaces may immediately move 2 spaces without provoking.'],
    ...
    ['Concord', 'quick', 'round', 1, 'One ally within 5 spaces regains its reaction.'],
  ...
  channeler: [
    ...
    ['Charge', 'quick', 'round', 1, 'Your next technique hit before the end of your next turn deals an additional 1d8 {damage} damage.'],
    ...
    ['Phase', 'quick', 'round', 1, 'During the rest of this turn, your movement may pass through occupied spaces and solid cover.'],
